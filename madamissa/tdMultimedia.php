		...
		<td style="width:5%;height:600px;padding-left:5px;margin-left:5px;padding-top:0px;">
		  <div style="width:100%;height:100%;background-color: rgba(0, 0, 0, 0.2);padding-top:0px;float:top;">	
			<div id="Multimedia">
				<img src="images/ongletDroit/playlist.jpg" style="width:95%;height:auto;margin:5px 5px 0px 5px;">
			  ...
			  <div id="myCarousel" class="carousel slide" data-ride="carousel"style="width: 98%;margin:2px;">
				...
				<div class="carousel-inner" role="listbox">
				  ...
				  <div class="item active" style="height:245px;">
					<img src="images/ongletDroit/carousel/isabelle.png" alt="Chania"style="width:216px;height:245px;">
				  </div>
				  
				  <div class="item" style="height:245px;">
					<img src="images/ongletDroit/carousel/75.JPG" alt="Chania" style="width:216px;height:245px;">
				  </div>
				
				  <div class="item" style="height:245px;">
					<img src="images/ongletDroit/carousel/42.JPG" alt="Flower" style="width:216px;height:245px;">
				  </div>

				  <div class="item" style="height:245px;">
					<img src="images/ongletDroit/carousel/14.JPG" alt="Flower" style="width:216px;height:245px;">
				  </div>
				</div>
